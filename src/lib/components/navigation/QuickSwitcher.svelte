              ...
              >
                {#if note.protection?.level === 'protected'}
                  {#if note.protection.lockState === 'locked'}
                    <Lock class="note-icon protected-icon" size={16} strokeWidth={1.7} aria-hidden="true" />
                  {:else}
                    <Unlock class="note-icon protected-icon" size={16} strokeWidth={1.7} aria-hidden="true" />
                  {/if}
                {:else}
                  <FileText class="note-icon" size={16} strokeWidth={1.5} aria-hidden="true" />
                {/if}
                <div class="note-info">
