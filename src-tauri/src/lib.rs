...
use commands::{
    asset_delete, asset_download_image, asset_import_bytes, asset_import_file, asset_list,
    asset_metadata, asset_resolve_asset_url, asset_save_as, cancel_cli_process,
    check_cli_available, create_directory, delete_credential, delete_file, file_exists,
    folder_access_create_bookmark, folder_access_request_access, folder_access_resolve_bookmark,
    folder_access_start, folder_access_stop, get_active_process_count, get_active_processes,
    get_credential, get_settings, get_settings_path, git_abort_merge, git_begin_merge,
    git_build_divergence_conflict, git_commit_all, git_commit_merge, git_create_branch,
    git_create_recovery_branch, git_detect, git_ensure_artifact_policy, git_fetch, git_init,
    git_is_merge_in_progress, git_list_local_branches, git_list_merge_conflicts, git_pull_ff,
    git_push, git_push_dry_run, git_read_merge_file, git_read_remote_file, git_set_remote,
    git_stage_paths, git_switch_branch, git_write_working_file, github_begin_device_auth,
    github_check_repo_name, github_complete_device_auth, github_create_repo, github_get_repository,
    github_get_void_ready, github_list_branches, github_list_repositories, github_revoke_token,
    github_validate_token, has_credential, list_directory, move_to_trash,
    ...
    protection_wrap_key_with_passphrase, read_file, remove_directory, rename_path, run_cli_prompt,
    save_settings, spawn_cli_process, start_clipboard_watcher, store_credential, unwatch_all,
    unwatch_directory, void_append_jsonl, void_append_provenance, void_ensure_dir, void_list_dir,
...
pub fn run() {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            asset_import_file,
            asset_import_bytes,
            asset_download_image,
            asset_metadata,
            asset_list,
            asset_save_as,
            asset_delete,
            asset_resolve_asset_url,
            folder_access_create_bookmark,
            folder_access_request_access,
            folder_access_resolve_bookmark,
            folder_access_start,
            folder_access_stop,
            // Settings commands
            get_settings,
